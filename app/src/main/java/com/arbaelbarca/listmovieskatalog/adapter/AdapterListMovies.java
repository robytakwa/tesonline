...
public class AdapterListMovies extends RecyclerView.Adapter<AdapterListMovies.MyHolder> {

    private Context context;
    private ArrayList<ResultsItem> resultsItemArrayList;

    public void setMovies(ArrayList<ResultsItem> movies) {
        this.resultsItemArrayList = movies;
    }

    public AdapterListMovies(Context context) {
