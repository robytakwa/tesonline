...
//                        ",genre_ids = '" + genreIds + '\'' +
    ...
    class ConverterListToString {
        @TypeConverter
        public List<ResultsItem> storedStringToMyObjects(String data) {
            Gson gson = new Gson();
            if (data == null) {
                return Collections.emptyList();
            }
            Type listType = new TypeToken<List<ResultsItem>>() {
            }.getType();
            return gson.fromJson(data, listType);
        }

        @TypeConverter
        public String myObjectsToStoredString(List<ResultsItem> myObjects) {
            Gson gson = new Gson();
