...
class AdapterFavoriteMovies(private val context: Context) : RecyclerView.Adapter<AdapterFavoriteMovies.MyHolder>() {
    private var resultsItemArrayList: List<ResultsItem>? = null
    ...
    inner class MyHolder(view: View) : RecyclerView.ViewHolder(view) {
        private var txtName: TextView = view.findViewById(R.id.tv_item_name)
